...
export const AUDIO_URL =
  "https://raw.githubusercontent.com/freeCodeCamp/cdn/master/build/testable-projects-fcc/audio/BeepSound.wav"; // Link to audio file that plays when countdown finishes

// Visuals
export const CHOOSE_LENGTH_ICON_SIZE = 35; // In pixels
export const BUTTON_ICON_SIZE = 40; // In pixels
